...
def generate_retry_voices():
    ...
    text = "Perdón, no escuché bien. ¿Puedes repetirlo, por favor?"
    result = {}
    for role_dict in roles[1:2]:
        role = Role(**role_dict)
        loop = asyncio.get_event_loop()
...
{1: 'http://localhost:8082/voice-64cd81cb8e2d4735bd9d3e3c91747514.mp3', 2: 'http://localhost:8082/voice-b1cc2e88103f41b9aea0c9fbb4b4eeb3.mp3', 3: 'http://localhost:8082/voice-0a0f63a367c140a3a25befce3b01f7a4.mp3'}
{1: 'http://localhost:8082/voice-8cdc23396a1f4316998d8687a3a4c81f.mp3', 2: 'http://localhost:8082/voice-47b7bdacc5e24cfabd9e5be3f6b34ac9.mp3', 3: 'http://localhost:8082/voice-89232610d72a4073a22e59a60f330060.mp3'}
"""
